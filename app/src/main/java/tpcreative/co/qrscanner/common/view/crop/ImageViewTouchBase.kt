...
internal abstract class ImageViewTouchBase : AppCompatImageView {
    ...
    // the full size image.
    protected var baseMatrix: Matrix? = Matrix()
    ...
    protected var suppMatrix: Matrix? = Matrix()
    ...
    private fun setImageBitmap(bitmap: Bitmap?, rotation: Int) {
        ...
        val d = drawable
        d?.setDither(true)
        val old = bitmapDisplayed.getBitmap()
    ...
    protected fun zoomTo(scale: Float, centerX: Float,
