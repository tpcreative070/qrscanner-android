...
object PrefsController {
    ...
    class Builder {
        ...
        /**
         * Set the default sharedpreference file name. Often the package name of the application is used, but if the [android.preference.PreferenceActivity] or [android.preference.PreferenceFragment] is used android append that with _preference.
         *
