...
import tpcreative.co.qrscanner.common.network.BaseDependencies
...
object RetrofitBuilder : BaseDependencies() {
    private val BASE_URL = QRScannerApplication.getInstance()?.getUrl() ?: ""
    ...
    fun getService(url : String? = null,listener : ProgressResponseBody.ProgressResponseBodyListener? = null,typeService : EnumTypeServices): RootAPI? {
