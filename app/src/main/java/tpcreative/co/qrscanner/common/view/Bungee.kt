...
object Bungee {
    ...
    fun swipeLeft(context: Context?) {
        (context as Activity?)?.overridePendingTransition(R.anim.swipe_left_enter, R.anim.swipe_left_exit)
    }

    fun swipeRight(context: Context?) {
        (context as Activity?)?.overridePendingTransition(R.anim.swipe_right_enter, R.anim.swipe_right_exit)
    }
}