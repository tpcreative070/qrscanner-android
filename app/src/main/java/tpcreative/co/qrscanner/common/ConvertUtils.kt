...
class ConvertUtils private constructor() {
    ...
    companion object {
        ...
        fun bitmap2Drawable(bitmap: Bitmap?): Drawable? {
            return if (bitmap == null) null else BitmapDrawable(QRScannerApplication.Companion.getInstance().getResources(), bitmap)
        }
        ...
        fun dp2px(dpValue: Float): Int {
            val scale: Float = QRScannerApplication.Companion.getInstance().getResources().getDisplayMetrics().density
        ...
        fun sp2px(spValue: Float): Int {
            val fontScale: Float = QRScannerApplication.Companion.getInstance().getResources().getDisplayMetrics().scaledDensity
