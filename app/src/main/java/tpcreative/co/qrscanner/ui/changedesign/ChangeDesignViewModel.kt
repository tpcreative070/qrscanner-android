...
class ChangeDesignViewModel  : BaseViewModel<ItemNavigation>(){
    ...
    var mList: MutableList<ChangeDesignModel> = mutableListOf()
    var create: GeneralModel = GeneralModel()
    var enumView  = EnumView.ALL_HIDDEN
    var logoSelectedIndex : Int = -1
    var mLogoList = mutableListOf<ChangeDesignModel>()
    ...
    fun getData(callback: (result: MutableList<ChangeDesignModel>) -> Unit){
        mList.clear()
        mList.add(
            ChangeDesignModel(R.drawable.ic_template,QRScannerApplication.getInstance().getString(R.string.template),EnumView.TEMPLATE,false,R.color.transparent,true)
        )
        mList.add(
            ChangeDesignModel(R.drawable.ic_paint,QRScannerApplication.getInstance().getString(R.string.color),EnumView.COLOR,false,R.color.transparent,true))
        mList.add(
            ChangeDesignModel(R.drawable.ic_dots,QRScannerApplication.getInstance().getString(R.string.dots),EnumView.DOTS,false,R.color.transparent,true)
        )
        mList.add(
            ChangeDesignModel(R.drawable.ic_eyes,QRScannerApplication.getInstance().getString(R.string.eyes),EnumView.EYES,false,R.color.transparent,true)
        )
        mList.add(
            ChangeDesignModel(R.drawable.ic_registered,QRScannerApplication.getInstance().getString(R.string.logo),EnumView.LOGO,false,R.color.transparent,true)
        )
        mList.add(
            ChangeDesignModel(R.drawable.ic_design_text,QRScannerApplication.getInstance().getString(R.string.text),EnumView.TEXT,false,R.color.transparent,true)
        )
        callback(mList)
    }
